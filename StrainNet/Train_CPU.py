...
parser.add_argument('--arch', default='StrainNet_f_CPU', choices=['StrainNet_f_CPU', 'StrainNet_h_CPU'],
                    help='network f or h')
...
def main():
    ...
    train_set = SpecklesDataset(
        csv_file='/Users/huiyuan/PycharmProjects/speckle-tracking/Dataset/Data/Train_annotations.csv',
        root_dir='/Users/huiyuan/PycharmProjects/speckle-tracking/Dataset/Data', transform=transform)
    test_set = SpecklesDataset(
        csv_file='/Users/huiyuan/PycharmProjects/speckle-tracking/Dataset/Data_test/Test_annotations.csv',
        root_dir='/Users/huiyuan/PycharmProjects/speckle-tracking/Dataset/Data_test', transform=transform)
